...
function BiBFS(matrix) {
  ...
  this.findPath = function() {
    ...
    while (_beginVisitList.length > 0 && _endVisitList.length > 0) {
      _currentCube = this.matrix.getCubeFromIndex(_beginVisitList.shift());
      ...
      _currentCube = this.matrix.getCubeFromIndex(_endVisitList.shift());
      this.matrix.setCubeVisited(_currentCube.x, _currentCube.y);
...
BiBFS.prototype = Object.assign(Object.create(PathFinder.prototype), {});
